    ...
    <div className="flex flex-col justify-evenly items-center h-screen">
      <section className="flex flex-col justify-center items-center gap-4">
        <h1 className="flex flex-col items-center text-6xl font-extrabold ">
          Degree Planning{' '}
          <span className="bg-gradient-to-r from-gradient-heading-l to-gradient-heading-r bg-clip-text text-transparent">
            Meets AI.
          </span>
        </h1>
        ...
        <Button className="bg-gradient-to-r from-gradient-primary-l to-gradient-primary-r font-bold text-white px-8 py-3">
